(function () {
  ...
  document.addEventListener("DOMContentLoaded", () => window.setTimeout(hideLoader, 1800));
  window.addEventListener("load", () => window.setTimeout(hideLoader, 1350));
  ...
  const words = ["familia", "derechos", "patrimonio", "trámites"];
  let wordIndex = 0;
  ...
  contactForm?.addEventListener("submit", (event) => {
    ...
    const text = [
      "Hola Lic. Jorge Aranda, quiero solicitar asesoría legal.",
  ...
  setupParticles(document.getElementById("heroParticles"), 58, true);
  document.querySelectorAll(".section-particles").forEach((canvas) => setupParticles(canvas, 28, false));
